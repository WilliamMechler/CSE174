...
public class MyFirstProgram{
  ...
  public static void main(String[] args){
    ...
    //Set up game
    goalNumber = (int) (1+30*Math.random());
    countGuesses = 1;
    ...
    //User wins if it takes fewer than 6 guesses
    if (countGuesses < 6){
      ...
      System.out.println("you got it, but took 6 or more tries.");
    }
  ...
  public static void printGameIntro(String name){
    ...
    System.out.println("I'm thinking of a number from 1 to 30.");
    System.out.println("See if you get it in fewer than 6 tries . . .");
